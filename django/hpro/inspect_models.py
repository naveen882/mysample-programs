...
class ActivityTaskConfigurations(models.Model):
    ...
    class Meta:
        managed = False
        db_table = 'activity_task_configurations'
...
class CampusDepartments(models.Model):
    degree_id = models.IntegerField(blank=True, null=True)
    branch_id = models.IntegerField(blank=True, null=True)
...
class CampusInformations(models.Model):
    ...
    num_of_companies_visited = models.IntegerField(blank=True, null=True)
    registered_under = models.CharField(max_length=255, blank=True, null=True)
    tenant_id = models.IntegerField(blank=True, null=True)
    created_by = models.IntegerField()
    created_on = models.DateTimeField()
    modified_by = models.IntegerField(blank=True, null=True)
    ...
    entrance_criteria = models.CharField(max_length=255, blank=True, null=True)
    calendar_info = models.TextField(blank=True, null=True)
    infrastructure_info = models.TextField(blank=True, null=True)
...
class Candidates(models.Model):
    ...
    text_area4 = models.CharField(max_length=3000, blank=True, null=True)
...
class CtcStructures(models.Model):
    ...
    custom_field_label_a6 = models.CharField(max_length=45, blank=True, null=True)
    custom_field_label_a7 = models.CharField(max_length=45, blank=True, null=True)
    custom_field_label_a8 = models.CharField(max_length=45, blank=True, null=True)
    custom_field_label_a9 = models.CharField(max_length=45, blank=True, null=True)
    custom_field_label_a10 = models.CharField(max_length=45, blank=True, null=True)
    custom_field_label_a11 = models.CharField(max_length=45, blank=True, null=True)
    custom_field_label_a12 = models.CharField(max_length=45, blank=True, null=True)
    custom_field_percent_a6 = models.FloatField(blank=True, null=True)
    custom_field_percent_a7 = models.FloatField(blank=True, null=True)
    custom_field_flat_a8 = models.FloatField(blank=True, null=True)
    custom_field_flat_a9 = models.FloatField(blank=True, null=True)
    custom_field_flat_a10 = models.FloatField(blank=True, null=True)
    custom_field_flat_a11 = models.FloatField(blank=True, null=True)
    custom_field_flat_a12 = models.FloatField(blank=True, null=True)
...
class FormControlConfigurations(models.Model):
    name = models.CharField(max_length=255, blank=True, null=True)
    label = models.CharField(max_length=255, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'form_control_configurations'
...
class GroupMembers(models.Model):
    ...
    modified_by = models.IntegerField(blank=True, null=True)
    modified_on = models.DateTimeField(blank=True, null=True)
    candidategroup = models.ForeignKey(CandidateGroups, blank=True, null=True)
...
class Jobs(models.Model):
    ...
    other_interviewer = models.CharField(max_length=45, blank=True, null=True)
...
class LiteCandidate(models.Model):
    ...
    is_draft = models.TextField(blank=True, null=True)  # This field type is a guess.
    is_archived = models.IntegerField(blank=True, null=True)
    is_alive = models.TextField(blank=True, null=True)  # This field type is a guess.
    published_on = models.DateTimeField(blank=True, null=True)
    published_by = models.IntegerField(blank=True, null=True)
...
class MasterReports(models.Model):
    ...
    cost_centre = models.CharField(max_length=45, blank=True, null=True)
    replacement = models.CharField(max_length=45, blank=True, null=True)
...
class PaperSets(models.Model):
    ...
    sub_category_answer_string = models.CharField(max_length=255, blank=True, null=True)
...
class PlacementCalendars(models.Model):
    version = models.IntegerField()
    ...
    class Meta:
        managed = False
        db_table = 'placement_calendars'


class PlacementContactInfos(models.Model):
    name = models.CharField(max_length=255, blank=True, null=True)
    ...
    class Meta:
        managed = False
        db_table = 'placement_contact_infos'


class PlacementTrends(models.Model):
...
class QuestionPaperInfos(models.Model):
    ...
    qp_information = models.CharField(max_length=5000, blank=True, null=True)
    ...
    status_id = models.IntegerField(blank=True, null=True)
    master_answer_string = models.CharField(max_length=1000, blank=True, null=True)
    sub_category_answer_string = models.CharField(max_length=1000, blank=True, null=True)
    preview_id = models.IntegerField(blank=True, null=True)
...
class RecruitEvents(models.Model):
    ...
    is_utilized = models.IntegerField()
    anchor_text = models.CharField(max_length=1000, blank=True, null=True)
    college_text = models.CharField(max_length=1000, blank=True, null=True)
...
class SkillsAssesseds(models.Model):
    ...
    skill_comment = models.CharField(max_length=500, blank=True, null=True)
    created_by = models.IntegerField()
    created_on = models.DateTimeField()
    modified_by = models.IntegerField(blank=True, null=True)
    modified_on = models.DateTimeField(blank=True, null=True)
...
class StaffingUserTasks(models.Model):
    version = models.IntegerField()
    due_date = models.DateTimeField(blank=True, null=True)
    status = models.IntegerField(blank=True, null=True)
    assignee_user_id = models.IntegerField(blank=True, null=True)
...
class TestResultInfos(models.Model):
    ...
    coding_output = models.CharField(max_length=10000, blank=True, null=True)
    coding_error_message = models.CharField(max_length=10000, blank=True, null=True)
    coding_error_code = models.CharField(max_length=255, blank=True, null=True)
    created_by = models.IntegerField()
    created_on = models.DateTimeField()
    modified_by = models.IntegerField(blank=True, null=True)
    modified_on = models.DateTimeField(blank=True, null=True)
...
class TestResults(models.Model):
    question_id = models.IntegerField()
    answer_string = models.CharField(max_length=4000, blank=True, null=True)
...
class TypingResult(models.Model):
    ...
    time_taken_sec = models.IntegerField()
    chars_per_min = models.FloatField()
    accuracy = models.FloatField()
    submit_date_time = models.DateTimeField()

    class Meta:
        managed = False
        db_table = 'typing_result'
