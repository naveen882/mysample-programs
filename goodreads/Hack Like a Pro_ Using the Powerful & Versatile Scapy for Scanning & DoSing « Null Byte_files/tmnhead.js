/* Purch Ad Tag API V5.4.12 Copyright 2016 Purch, Inc.*/
var TMNAPI_VERSION="5.4.12";
...
if ("Computer"==="Mobile") {
	PREBID_TIMEOUT = ("200"===""||"200".indexOf('$')===0)?1:"200"*1;
}
...
tmntag.video.start=function(divid, videoSettings, videoPlayer, adunitDivid) {
	if (typeof videoSettings.advertising=='undefined') videoSettings.advertising = {client:"googima"};
	if (typeof adunitDivid=='undefined') adunitDivid = divid;
	videoPlayer.setup(videoSettings);
...
tmntag.video.adTag=function(divid, playerId){
	if (typeof adunitAccount=='undefined') {
		var adunit = tmntag_getAdunitFromCache(divid);
...
nuggSrc.setAttribute('src', ('https:' === document.location.protocol ? 'https:' : 'http:') + '//bestofmedia.nuggad.net/rc?nuggn=463276050&nuggsid='+_nuggadID+'&nuggrid='+encodeURIComponent(top.location.href)+'&nuggtg=contentClassifier');
